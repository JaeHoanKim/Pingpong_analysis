...
###############################################################
#%% 5.calculate the variance of each pixel among the frames ###
###############################################################
...
#######################################################
#%% 7. thresholding 1 - to clarify trajectory range ###
#######################################################
...
############################################################################
#%% 8. thresholding 2 - to extract ball location using color information ###
############################################################################
...
#######################################################
#%% 9. Compare the loaction with the original image ###
#######################################################

plt.imshow(cv2.cvtColor(frame_test, cv2.COLOR_BGR2RGB))

######################################################################
#%% 10. find contour and extract the exact center of pingpong ball ###
######################################################################
...
cv2.drawContours(frame_with_ctr, contours=contours, contourIdx=-1, color=(255, 0, 255))
